 ...
 */
public class LyricsHandlerFake {
    boolean foundLyrics = false;
    String lyricsText = null;
    ID3v1HandlerFake id3v1 = null;

    public LyricsHandlerFake(InputStream stream, ContentHandler handler)
     ...
     */
    protected LyricsHandlerFake(byte[] tagData)
            throws IOException, SAXException, TikaException {
        ...
        id3v1 = new ID3v1HandlerFake(last128);
